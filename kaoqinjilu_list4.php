...
<form id="form1" name="form1" method="post" action="">
  搜索: 学号：<input name="xuehao" type="text" id="xuehao" /> 姓名：<input name="xingming" type="text" id="xingming" /> 所在班级：<input name="suozaibanji" type="text" id="suozaibanji" /> 性别：<input name="xingbie" type="text" id="xingbie" /> 课程名称：<input name="kechengmingcheng" type="text" id="kechengmingcheng" /> 任课教师：<input name="renkejiaoshi" type="text" id="renkejiaoshi" /> 上课时间：<input name="shangkeshijian1" type="text" id="shangkeshijian1"  value='' onclick="getDate(form1.shangkeshijian1,'2')" size="10" need="1" />-<input name="shangkeshijian2" type="text" id="shangkeshijian2"  value='' onclick="getDate(form1.shangkeshijian2,'2')" size="10" need="1" /> 状态：
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#000000" style="border-collapse:collapse">
  ...
  <?php 
    $sql="select * from kaoqinjilu where suozaibanji in (select suozaibanji from xueshengxinxi where xuehao='".$_SESSION["username"]."')";
...
<form id="form2" name="form2" method="post" action="">
  <div align="center"><a href="kaoqinjilu_list4.php?pagecurrent=1">首页</a>, <a href="kaoqinjilu_list4.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="kaoqinjilu_list4.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="kaoqinjilu_list4.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 跳转至
