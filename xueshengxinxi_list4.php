...
?></td>
    ...
    <td width="90" align="center"><a href="weijiqingkuang_add.php?id=<?php echo mysql_result($query,$i,"id");?>">违纪</a> <a href="xueshengxinxi_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
  </tr>
  	<?php
	}
}
