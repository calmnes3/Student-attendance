...
if ($addnew=="1" )
{
	$xuehao=$_POST["xuehao"];$xingming=$_POST["xingming"];$xingbie=$_POST["xingbie"];$minzu=$_POST["minzu"];$zhengzhimianmao=$_POST["zhengzhimianmao"];$leibie=$_POST["leibie"];$suozaibanji=$_POST["suozaibanji"];$lianxifangshi=$_POST["lianxifangshi"];$shenfenzhenghaoma=$_POST["shenfenzhenghaoma"];$jiatingxiangxizhuzhi=$_POST["jiatingxiangxizhuzhi"];$gerenzhaopian=$_POST["gerenzhaopian"];$fuqinxingming=$_POST["fuqinxingming"];$fuqingongzuodanwei=$_POST["fuqingongzuodanwei"];$fuqinlianxidianhua=$_POST["fuqinlianxidianhua"];$jiatinglianxidianhua=$_POST["jiatinglianxidianhua"];$muqinxingming=$_POST["muqinxingming"];$muqingongzuodanwei=$_POST["muqingongzuodanwei"];$muqinlianxidianhua=$_POST["muqinlianxidianhua"];$mima=$_POST["mima"];
	$sql="update xueshengxinxi set xuehao='$xuehao',xingming='$xingming',xingbie='$xingbie',minzu='$minzu',zhengzhimianmao='$zhengzhimianmao',leibie='$leibie',suozaibanji='$suozaibanji',lianxifangshi='$lianxifangshi',shenfenzhenghaoma='$shenfenzhenghaoma',jiatingxiangxizhuzhi='$jiatingxiangxizhuzhi',gerenzhaopian='$gerenzhaopian',fuqinxingming='$fuqinxingming',fuqingongzuodanwei='$fuqingongzuodanwei',fuqinlianxidianhua='$fuqinlianxidianhua',jiatinglianxidianhua='$jiatinglianxidianhua',muqinxingming='$muqinxingming',muqingongzuodanwei='$muqingongzuodanwei',muqinlianxidianhua='$muqinlianxidianhua',mima='$mima' where xuehao= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<?php
$sql="select * from xueshengxinxi where xuehao='".$_SESSION["username"]."'";
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#000000" style="border-collapse:collapse">
      <tr><td>学号：</td><td><input name='xuehao' type='text' id='xuehao' value='<?php echo mysql_result($query,$i,xuehao);?>' /></td></tr><tr><td>姓名：</td><td><input name='xingming' type='text' id='xingming' value='<?php echo mysql_result($query,$i,xingming);?>' /></td></tr><tr><td>性别：</td><td><select name='xingbie' id='xingbie'>
        <option value="男">男</option>
        <option value="女">女</option>
      </select>
      </td></tr><tr><td>民族：</td><td><select name='minzu' id='minzu' style='border:solid 1px #000000; color:#666666'>
