...
<title>日常表现</title><script language="javascript" src="js/Calendar.js"></script><link rel="stylesheet" href="css.css" type="text/css">
</head>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#000000" style="border-collapse:collapse">
  <tr>
    ...
    <td bgcolor='#FFFFFF'>学号</td><td bgcolor='#FFFFFF'>姓名</td><td bgcolor='#FFFFFF'>所在班级</td><td bgcolor='#FFFFFF'>获得时间</td><td bgcolor='#FFFFFF'>参加活动类型</td><td bgcolor='#FFFFFF'>外语等级</td><td bgcolor='#FFFFFF'>个人荣誉</td><td bgcolor='#FFFFFF'>突出贡献</td><td bgcolor='#FFFFFF'>备注</td>
...
?></td>
    <td width="90" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=richangbiaoxian" onclick="return confirm('真的要删除？')">删除</a> <a href="richangbiaoxian_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="richangbiaoxian_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="richangbiaoxian_list2.php?pagecurrent=1">首页</a>, <a href="richangbiaoxian_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="richangbiaoxian_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="richangbiaoxian_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
