...
<form id="form1" name="form1" method="post" action="">
  ...
  所在班级：
  <select name='suozaibanji' id='suozaibanji'><option value="">所有</option><?php getoption("banjixinxi","banji")?></select>
...
if ($_POST["province"]!=""){$nprovince=$_POST["province"];$sql=$sql." and jiatingxiangxizhuzhi like '%$nprovince%'";}
...
?></td>
    ...
    <td width="65" align="center"><a href="sh.php?id=<?php echo mysql_result($query,$i,id);?>&amp;yuan=<?php echo mysql_result($query,$i,issh);?>&amp;tablename=xueshengxinxi"><?php echo mysql_result($query,$i,issh);?></a></td>
    <td width="90" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=xueshengxinxi" onclick="return confirm('真的要删除？')">删除</a> <a href="xueshengxinxi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="xueshengxinxi_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
  </tr>
  	<?php
	}
}
...
<form id="form2" name="form2" method="post" action="">
  <div align="center"><a href="xueshengxinxi_list.php?pagecurrent=1">首页</a>, <a href="xueshengxinxi_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="xueshengxinxi_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="xueshengxinxi_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 跳转至
