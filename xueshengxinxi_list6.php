...
<form id="form1" name="form1" method="post" action="">
  搜索: 学号：<input name="xuehao" type="text" id="xuehao" /> 姓名：<input name="xingming" type="text" id="xingming" /> 性别：<select name='xingbie' id='xingbie'><option value="">所有</option><option value="男">男</option><option value="女">女</option></select> 民族：
  <select name='minzu' id='minzu' style='border:solid 1px #000000; color:#666666'>
    <option value="">所有</option>
	<option value="汉族">汉族</option>
    <option value="苗族">苗族</option>
  </select> 
  政治面貌：
  <select name='zhengzhimianmao' id='zhengzhimianmao' style='border:solid 1px #000000; color:#666666'>
  <option value="">所有</option>
  ...
  所在班级：
  <select name='suozaibanji' id='suozaibanji'><option value="">所有</option><?php getoption("banjixinxi","banji")?></select></select> 联系方式：<input name="lianxifangshi" type="text" id="lianxifangshi" /> 身份证号码：<input name="shenfenzhenghaoma" type="text" id="shenfenzhenghaoma" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#000000" style="border-collapse:collapse">
  <tr>
    ...
    <td bgcolor='#FFFFFF'>学号</td><td bgcolor='#FFFFFF'>姓名</td><td bgcolor='#FFFFFF'>性别</td><td bgcolor='#FFFFFF'>民族</td><td bgcolor='#FFFFFF'>政治面貌</td><td bgcolor='#FFFFFF'>类别</td><td bgcolor='#FFFFFF'>所在班级</td><td bgcolor='#FFFFFF'>联系方式</td><td bgcolor='#FFFFFF'>身份证号码</td><!--<td bgcolor='#FFFFFF'>个人照片</td>-->
    <td width="65" align="center" bgcolor="#FFFFFF">是否班长</td>
...
?></td>
    ...
    <td width="65" align="center"><?php echo mysql_result($query,$i,issh);?></td>
    <td width="90" align="center"><a href="xueshengxinxi_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p>以上数据共<?php
  ...
  <input type="button" name="Submit22" onclick="javascript:location.href='xueshengxinxi_listxls.php';" value="生成EXCEL" style='border:solid 1px #000000; color:#666666' />
</p>
<form id="form2" name="form2" method="post" action="">
  <div align="center"><a href="xueshengxinxi_list6.php?pagecurrent=1">首页</a>, <a href="xueshengxinxi_list6.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="xueshengxinxi_list6.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="xueshengxinxi_list6.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 跳转至
