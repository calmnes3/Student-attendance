...
<p>以上数据共<?php
  ...
  <input type="button" name="Submit22" onclick="javascript:location.href='richangbiaoxian_listxls.php';" value="生成EXCEL" style='border:solid 1px #000000; color:#666666' />
</p>
<form id="form2" name="form2" method="post" action="">
  <div align="center"><a href="richangbiaoxian_list.php?pagecurrent=1">首页</a>, <a href="richangbiaoxian_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="richangbiaoxian_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="richangbiaoxian_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 跳转至
